...
def ingest_docs(temp_dir: str = tempfile.gettempdir()):
    ...
    try:
        ...
        if not openai_api_key or not pinecone_api_key or not pinecone_environment or not pinecone_index:
            raise ValueError(
...
def main():
    ...
    if st.session_state['ready']:
        ...
        vectorstore = Pinecone.from_existing_index(
            index_name=pinecone_index, embedding=embeddings, text_key='text')
